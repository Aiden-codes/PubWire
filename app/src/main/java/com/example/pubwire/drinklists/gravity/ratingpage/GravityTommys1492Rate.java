...
public class GravityTommys1492Rate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(GravityTommys1492Rate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityTommys1492Rate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(GravityTommys1492Rate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityTommys1492Rate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(GravityTommys1492Rate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(GravityTommys1492Rate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(GravityTommys1492Rate.this, Login.class));
                        }
                    }
                    default:
                        return GravityTommys1492Rate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if(user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(GravityTommys1492Rate.this, GravityDrinkList.class));

                    Toast.makeText(GravityTommys1492Rate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(GravityTommys1492Rate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(GravityTommys1492Rate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
