...
public class GravityMartiniDoItBitterRate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(GravityMartiniDoItBitterRate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityMartiniDoItBitterRate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(GravityMartiniDoItBitterRate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityMartiniDoItBitterRate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(GravityMartiniDoItBitterRate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(GravityMartiniDoItBitterRate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(GravityMartiniDoItBitterRate.this, Login.class));
                        }
                    }
                    default:
                        return GravityMartiniDoItBitterRate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if(user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(GravityMartiniDoItBitterRate.this, GravityDrinkList.class));

                    Toast.makeText(GravityMartiniDoItBitterRate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(GravityMartiniDoItBitterRate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(GravityMartiniDoItBitterRate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
