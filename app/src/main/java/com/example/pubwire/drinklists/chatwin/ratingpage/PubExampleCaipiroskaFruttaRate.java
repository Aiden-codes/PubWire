...
public class PubExampleCaipiroskaFruttaRate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(PubExampleCaipiroskaFruttaRate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(PubExampleCaipiroskaFruttaRate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(PubExampleCaipiroskaFruttaRate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(PubExampleCaipiroskaFruttaRate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(PubExampleCaipiroskaFruttaRate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(PubExampleCaipiroskaFruttaRate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(PubExampleCaipiroskaFruttaRate.this, Login.class));
                        }
                    }
                    default:
                        return PubExampleCaipiroskaFruttaRate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if (user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(PubExampleCaipiroskaFruttaRate.this, ChatwinDrinkList.class));

                    Toast.makeText(PubExampleCaipiroskaFruttaRate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(PubExampleCaipiroskaFruttaRate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(PubExampleCaipiroskaFruttaRate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
