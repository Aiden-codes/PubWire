...
public class GravityIndianSpritzRate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(GravityIndianSpritzRate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityIndianSpritzRate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(GravityIndianSpritzRate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityIndianSpritzRate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(GravityIndianSpritzRate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(GravityIndianSpritzRate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(GravityIndianSpritzRate.this, Login.class));
                        }
                    }
                    default:
                        return GravityIndianSpritzRate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if(user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(GravityIndianSpritzRate.this, GravityDrinkList.class));

                    Toast.makeText(GravityIndianSpritzRate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(GravityIndianSpritzRate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(GravityIndianSpritzRate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
