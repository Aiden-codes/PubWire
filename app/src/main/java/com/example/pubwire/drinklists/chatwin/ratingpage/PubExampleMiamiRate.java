...
public class PubExampleMiamiRate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(PubExampleMiamiRate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(PubExampleMiamiRate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(PubExampleMiamiRate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(PubExampleMiamiRate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(PubExampleMiamiRate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(PubExampleMiamiRate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(PubExampleMiamiRate.this, Login.class));
                        }
                    }
                    default:
                        return PubExampleMiamiRate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if (user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(PubExampleMiamiRate.this, ChatwinDrinkList.class));

                    Toast.makeText(PubExampleMiamiRate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(PubExampleMiamiRate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(PubExampleMiamiRate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
