...
public class GravityMexicoNuvoleRate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(GravityMexicoNuvoleRate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityMexicoNuvoleRate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(GravityMexicoNuvoleRate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GravityMexicoNuvoleRate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(GravityMexicoNuvoleRate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(GravityMexicoNuvoleRate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(GravityMexicoNuvoleRate.this, Login.class));
                        }
                    }
                    default:
                        return GravityMexicoNuvoleRate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if(user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(GravityMexicoNuvoleRate.this, GravityDrinkList.class));

                    Toast.makeText(GravityMexicoNuvoleRate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(GravityMexicoNuvoleRate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(GravityMexicoNuvoleRate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
