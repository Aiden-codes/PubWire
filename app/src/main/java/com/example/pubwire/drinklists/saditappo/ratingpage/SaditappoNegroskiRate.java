...
public class SaditappoNegroskiRate extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(SaditappoNegroskiRate.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(SaditappoNegroskiRate.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(SaditappoNegroskiRate.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(SaditappoNegroskiRate.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(SaditappoNegroskiRate.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(SaditappoNegroskiRate.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(SaditappoNegroskiRate.this, Login.class));
                        }
                    }
                    default:
                        return SaditappoNegroskiRate.super.onOptionsItemSelected(item);
                }
            }
        });
        ...
        if (user != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(SaditappoNegroskiRate.this, SaditappoDrinkList.class));

                    Toast.makeText(SaditappoNegroskiRate.this, "Rating submitted!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(SaditappoNegroskiRate.this, "You need to Log In to rate!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        ratingBar.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    Toast.makeText(SaditappoNegroskiRate.this, String.valueOf(ratingBar.getRating()), Toast.LENGTH_SHORT).show();
                    v.setPressed(false);
                }
