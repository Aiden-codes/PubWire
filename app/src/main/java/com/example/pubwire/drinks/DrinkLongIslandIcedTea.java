...
public class DrinkLongIslandIcedTea extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkLongIslandIcedTea.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkLongIslandIcedTea.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkLongIslandIcedTea.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkLongIslandIcedTea.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkLongIslandIcedTea.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkLongIslandIcedTea.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkLongIslandIcedTea.this, Login.class));
                        }
                    }
                    default:
                        return DrinkLongIslandIcedTea.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkLongIslandIcedTea.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkLongIslandIcedTea.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkLongIslandIcedTea.this, Gravity.class));
                            default:
                                break;
                        }
                    }
