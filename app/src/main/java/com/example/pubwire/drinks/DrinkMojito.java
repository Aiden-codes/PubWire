...
public class DrinkMojito extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkMojito.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkMojito.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkMojito.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkMojito.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkMojito.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkMojito.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkMojito.this, Login.class));
                        }
                    }
                    default:
                        return DrinkMojito.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkMojito.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkMojito.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkMojito.this, Gravity.class));
                            default:
                                break;
                        }
                    }
