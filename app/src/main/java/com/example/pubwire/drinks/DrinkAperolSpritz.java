...
public class DrinkAperolSpritz extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkAperolSpritz.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkAperolSpritz.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkAperolSpritz.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkAperolSpritz.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkAperolSpritz.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkAperolSpritz.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkAperolSpritz.this, Login.class));
                        }
                    }
                    default:
                        return DrinkAperolSpritz.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkAperolSpritz.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkAperolSpritz.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkAperolSpritz.this, Gravity.class));
                            default:
                                break;
                        }
                    }
