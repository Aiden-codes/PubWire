...
public class DrinkLondonMule extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkLondonMule.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkLondonMule.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkLondonMule.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkLondonMule.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkLondonMule.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkLondonMule.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkLondonMule.this, Login.class));
                        }
                    }
                    default:
                        return DrinkLondonMule.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkLondonMule.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkLondonMule.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkLondonMule.this, Gravity.class));
                            default:
                                break;
                        }
                    }
