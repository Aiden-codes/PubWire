...
public class DrinkDaiquiri extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkDaiquiri.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkDaiquiri.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkDaiquiri.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkDaiquiri.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkDaiquiri.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkDaiquiri.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkDaiquiri.this, Login.class));
                        }
                    }
                    default:
                        return DrinkDaiquiri.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkDaiquiri.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkDaiquiri.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkDaiquiri.this, Gravity.class));
                            default:
                                break;
                        }
                    }
