...
public class DrinkMargarita extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkMargarita.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkMargarita.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkMargarita.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkMargarita.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkMargarita.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkMargarita.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkMargarita.this, Login.class));
                        }
                    }
                    default:
                        return DrinkMargarita.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkMargarita.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkMargarita.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkMargarita.this, Gravity.class));
                            default:
                                break;
                        }
                    }
