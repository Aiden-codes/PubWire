...
public class DrinkTommys1492 extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(DrinkTommys1492.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkTommys1492.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(DrinkTommys1492.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DrinkTommys1492.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(DrinkTommys1492.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(DrinkTommys1492.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(DrinkTommys1492.this, Login.class));
                        }
                    }
                    default:
                        return DrinkTommys1492.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        switch (model.getName()) {
                            case "Chatwin Cafè":
                                startActivity(new Intent(DrinkTommys1492.this, Chatwin.class));
                                break;
                            case "Saditappo Gourmet":
                                startActivity(new Intent(DrinkTommys1492.this, Saditappo.class));
                                break;
                            case "Gravity Lounge & Food":
                                startActivity(new Intent(DrinkTommys1492.this, Gravity.class));
                            default:
                                break;
                        }
                    }
