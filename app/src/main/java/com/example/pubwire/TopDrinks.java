...
public class TopDrinks extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_maps:
                        Toast.makeText(TopDrinks.this, "MAPS", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(TopDrinks.this, GoogleMapsActivity.class));
                        break;
                    case R.id.action_home:
                        Toast.makeText(TopDrinks.this, "HOME", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(TopDrinks.this, MainActivity.class));
                        break;
                    case R.id.action_touber:
                        Toast.makeText(TopDrinks.this, "UBER", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_account: {
                        if (user != null) {
                            startActivity(new Intent(TopDrinks.this, AccountActivity.class));
                        } else {
                            startActivity(new Intent(TopDrinks.this, Login.class));
                        }
                    }
                    default:
                        return TopDrinks.super.onOptionsItemSelected(item);
                }
            }
        });
                ...
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (model.getDrinkName()) {
                            case "Mojito":
                                startActivity(new Intent(TopDrinks.this, DrinkMojito.class));
                                break;
                            case "Americano":
                                startActivity(new Intent(TopDrinks.this, DrinkAmericano.class));
                                break;
                            case "Aperol Spritz":
                                startActivity(new Intent(TopDrinks.this, DrinkAperolSpritz.class));
                                break;
                            case "Daiquiri":
                                startActivity(new Intent(TopDrinks.this, DrinkDaiquiri.class));
                                break;
                            case "London Mule":
                                startActivity(new Intent(TopDrinks.this, DrinkLondonMule.class));
                                break;
                            case "Long Island Iced Tea":
                                startActivity(new Intent(TopDrinks.this, DrinkLongIslandIcedTea.class));
                                break;
                            case "Margarita":
                                startActivity(new Intent(TopDrinks.this, DrinkMargarita.class));
                                break;
                            case "Tommys1492":
                                startActivity(new Intent(TopDrinks.this, DrinkTommys1492.class));
                                break;
                            default:
                                break;
                        }
