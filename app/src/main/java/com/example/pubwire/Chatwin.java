...
public class Chatwin extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                                switch (item.getItemId()) {
                                        case R.id.action_maps:
                                                Toast.makeText(Chatwin.this, "MAPS", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(Chatwin.this, GoogleMapsActivity.class));
                                                break;
                                        case R.id.action_home:
                                                Toast.makeText(Chatwin.this, "HOME", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(Chatwin.this, MainActivity.class));
                                                break;
                                        case R.id.action_touber:
                                                Toast.makeText(Chatwin.this, "UBER", Toast.LENGTH_SHORT).show();
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                        case R.id.action_account: {
                                                if (user != null) {
                                                        startActivity(new Intent(Chatwin.this, AccountActivity.class));
                                                } else {
                                                        startActivity(new Intent(Chatwin.this, Login.class));
                                                }
                                        }
                                        default:
                                                return Chatwin.super.onOptionsItemSelected(item);
                                }
                        }
                });
                ...
                button.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                                startActivity(new Intent(Chatwin.this, MainCommentActivity.class));
                        }
                });
                ...
                imgbutton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                                startActivity(new Intent(Chatwin.this, ChatwinDrinkList.class));
                        }
                });
